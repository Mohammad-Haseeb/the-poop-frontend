            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/trivia"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('trivia') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <MdOutlineNotListedLocation />
                  Trivia
              ...
              <li>
                <NavLink
                  to="/joke"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('joke') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <GiCardJoker />
                  Joke
              ...
              <li>
                <NavLink
                  to="/poop"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('poop') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <FaPoop />
                  Toilet
              ...
              <li>
                ...
                <div className="mt-20">
                  <button
                    onClick={() => {
                      localStorage.removeItem('user'); // Save the token or user data in localStorage
                      navigate('/'); // Redirect to the home page or dashboard after successful login
                    }}
                    className="rounded-full mb-4 block text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                    type="button"
                  >
                    Logout
                  </button>
